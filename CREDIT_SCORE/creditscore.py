...
def get_credit_score_category(score):
    if 800 <= score <= 900:
        ...
        return "<div style='background-color: #ADFF2F; padding: 10px; text-align: center; border-radius: 5px;'>Very Good</div>"  
    elif 670 <= score <= 739:
        return "<div style='background-color: yellow; padding: 10px; text-align: center; border-radius: 5px;'>Good</div>"
    elif 580 <= score <= 669:
        return "<div style='background-color: #FFD700; padding: 10px; text-align: center; border-radius: 5px;'>Fair</div>"  
    else:
